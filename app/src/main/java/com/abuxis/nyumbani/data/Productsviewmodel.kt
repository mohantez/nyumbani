package com.abuxis.nyumbani.data
...
import com.abuxis.nyumbani.Models.Product
import com.abuxis.nyumbani.Models.Upload
import com.abuxis.nyumbani.Navigation.ROUTE_LOGIN
...
class productviewmodel(var navController: NavHostController, var context: Context) {
    ...
    fun saveProductWithImage(
        ...
        storageReference.putFile(filePath as Uri).addOnCompleteListener {
            progress.dismiss()
            if (it.isSuccessful) {
